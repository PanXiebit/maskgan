...
tf.app.flags.DEFINE_string('base_directory', '//home/panxie/Document/GANS/maskgan/maskGAN_v0.00',
...
tf.app.flags.DEFINE_string('data_dir',
                           '/home/panxie/Document/GANS/maskgan/ptb/simple-examples/data',
...
def create_MaskGAN(hparams, is_training):
    ...
    (fake_sequence, fake_logits, fake_log_probs, fake_gen_initial_state,
     fake_gen_final_state) = model_construction.create_generator(
        hparams,
        inputs,
        targets,
        present,
